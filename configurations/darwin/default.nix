inputs: let
  ...
  in {
    MacbookProFull = mkDarwinConfig username { 
      custom.apps = [ "android" "vscode" "spotify" "htop" "uv" "cursor" "tex-live" "docker" "colima" "zsh" "openssl" "boost" "clang_tools" "llvm" "mlir" "lit" "chrome" "openmp" "discord" "ninja" "nodejs" "xcode" "neovim" "opencode" "pi" "cursor_agent" "glow" "life-tracker" "ffmpeg"];
    };
